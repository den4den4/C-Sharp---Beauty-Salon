...
namespace Final_project___Salon
{
    ...
    public partial class secretaryDisplayForm : Form
    {
        Form[] forms = new Form[6];// array of ref to forms
        ...
        string[] ButtonNames = { "Clients", "Squeduling", "Home", "Paying", "Settings", "Services" };
        //LogoNames ==> array of menu logos 
        string[] LogoNames = { "ClientsPictureBox", "SchuedulingPictureBox", "HomePictureBox", "PayingPictureBox", "SettingsPictureBox", "ServiceManagerPictureBox" };

        public secretaryDisplayForm(CompanyInfo company)
        {
            InitializeComponent();
            ...
            forms[3] = paying = new PayingForm();
            forms[4] = settings = new SettingsForm(company);
            forms[5] = service = new ServiceManagerForm();
        }
        ...
        /// </summary>
        private void secretaryDisplayForm_Load(object sender, EventArgs e)
        {
